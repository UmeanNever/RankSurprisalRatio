...
- 📀 **Data**: Available on [Hugging Face](https://huggingface.co/datasets/Umean/RSR_data). We release 33 math reasoning trajectory datasets used in our experiments, generated by 11 teacher models (3 datasets per teacher). These datasets can be directly used for reasoning distillation.
