...
- 📀 **Data**: Available on [Hugging Face](https://huggingface.co/datasets/Umean/RSR_data). We release 33 math trajectory datasets generated by 11 teacher models (3 datasets per teacher) used in our experiments, which can be directly used for reasoning distillation.
